...
A distance metric that normalizes differences by the range of the
feature.
...
\$\$\frac{1}{n}\sum\_{i=1}^{n}\frac{\|P_i - Q_i\|}{R_i}\$\$
...
#>          Saliva      Gums      Nose
#> Gums  0.2173035                    
#> Nose  0.7487885 0.6926051          
#> Stool 0.4236432 0.3655145 0.6688246
```

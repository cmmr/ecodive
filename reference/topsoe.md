...
\$\$\sum\_{i=1}^{n}P_i\ln\left(\frac{2P_i}{P_i + Q_i}\right) +
\sum\_{i=1}^{n}Q_i\ln\left(\frac{2Q_i}{P_i + Q_i}\right)\$\$
...
Topsoe, F. (2000). Some inequalities for information divergence and
related measures of discrimination. *IEEE Transactions on Information
Theory*, 46(4), 1602-1609.
[doi:10.1109/18.850703](https://doi.org/10.1109/18.850703)

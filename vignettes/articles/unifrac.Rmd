...
```{r input_data_tree, out.width = "100%", echo=FALSE}
  knitr::include_graphics('figures/unifrac-tree.png')
```
...
knitr::include_graphics('figures/unifrac-weights.png')
```
...
* R Package [OmicFlow](https://doi.org/10.32614/CRAN.package.OmicFlow): `unifrac(weighted=FALSE)`
...
* R Package [OmicFlow](https://doi.org/10.32614/CRAN.package.OmicFlow): `unifrac(weighted=TRUE, normalized=FALSE)`
...
* R Package [OmicFlow](https://doi.org/10.32614/CRAN.package.OmicFlow): `unifrac(weighted=TRUE, normalized=TRUE)`

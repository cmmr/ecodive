...
Weighted methods take relative abundances into account, whereas unweighted
methods only consider presence/absence. To determine which methods are weighted
or unweighted, consult `list_methods()`.

``` r
list_methods('beta', 'id', weighted = FALSE)
#> [1] "sorensen" "hamming"  "jaccard"  "ochiai"

list_methods('beta', 'id', weighted = TRUE)

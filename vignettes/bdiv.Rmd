...
* $X*_i$, $Y*_i$ : Rclr-transformed abundances of $X_i$ and $Y_i$ (see `robust_aitchison()` documentation).
...
| **Robust Aitchison distance**                   <br> `robust_aitchison()`  | $\displaystyle \sqrt{\sum_{i=1}^{n} (X^*_i - Y^*_i)^2}$ |

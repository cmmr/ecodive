...
resource_files:
  ...
  - '../man/figures/bray-benchmark.png'
...
#> 1         Generalized   10 - 1814x   310 - 69563x
#> 2          Unweighted    1 - 2251x    98 - 39485x
#> 3   Variance Adjusted 2353 - 2353x 90421 - 90421x
#> 4            Weighted   44 - 2094x   178 - 74013x
#> 5 Weighted Normalized   11 - 1991x   178 - 74049x
...
```{r out.width = "98%", echo=FALSE}
  knitr::include_graphics('../man/figures/bray-benchmark.svg')
```

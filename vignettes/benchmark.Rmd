...
| [tabula](https://github.com/LebeerLab/tabula)                      | ***Serial R***       | *none*             |
...
Only thirteen packages - `abdiv`, `adiv`, `ampvis2`, `ecodist`, `entropart`,
`GUniFrac`, `labdsv`, `phyloregion`, `phyloseq`, `picante`, `picante`, `tabula`,
and `vegan` - have their own implementations of these algorithms. Other R
packages import code from `ecodive`, `GUniFrac`, `phyloseq`, and/or `vegan` to
handle alpha and beta diversity computations. Therefore, only these thirteen
packages will be benchmarked.
...
pak::pkg_install(pkg = c(
  'adiv', 'abdiv', 'bench', 'ecodive', 'entropart', 'GUniFrac', 
  'kasperskytte/ampvis2', 'labdsv', 'philentropy', 'phylocomr', 
  'phyloregion', 'phyloseq', 'picante', 'rbiom', 'tabula', 'vegan' ))
...
sapply(FUN = packageDescription, fields = 'Version', c(
  'abdiv', 'adiv', 'ampvis2', 'ecodive', 'entropart', 'GUniFrac', 'labdsv', 
  'philentropy', 'phylocomr', 'phyloregion', 'phyloseq', 'picante', 'tabula', 'vegan' ))
#>        abdiv         adiv      ampvis2      ecodive    entropart     GUniFrac       labdsv 
#>      "0.2.0"      "2.2.1"      "2.8.9"      "1.0.1"     "1.6-16"        "1.8"      "2.1-2" 
#>  philentropy    phylocomr  phyloregion     phyloseq      picante       tabula        vegan 
#>      "0.9.0"      "0.3.4"      "1.0.9"     "1.52.0"      "1.8.2"      "3.3.1"      "2.7-1"

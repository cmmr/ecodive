...
| [ecodist](https://doi.org/10.32614/CRAN.package.ecodist)      | ***Serial R***   | *none*           |
...
| [phyloregion](https://github.com/schuyler-smith/phyloregion)  | vegan            | ***Serial R***   |
...
pak::pkg_install(pkg = c(
  ...
  'phyloregion', 'phyloseq', 'picante', 'rbiom', 'vegan' ))
...
sapply(FUN = packageDescription, fields = 'Version', c(
  'abdiv', 'adiv', 'ampvis2', 'ecodive', 'entropart', 'GUniFrac', 'phyloregion', 'phyloseq', 'picante', 'vegan' ))
#>    abdiv     adiv  ampvis2  ecodive  entropart  GUniFrac  phyloregion  phyloseq  picante    vegan
#>  "0.2.0"  "2.2.1"  "2.8.9"  "1.0.0"   "1.6-16"     "1.8"      "1.0.9"  "1.52.0"  "1.8.2"  "2.7-1"
